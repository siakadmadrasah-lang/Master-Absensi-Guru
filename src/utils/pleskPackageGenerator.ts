...
export async function createPleskZip(options: PleskExportOptions): Promise<Blob> {
  ...
  const pleskNowTs = Date.now();
  const pleskDomain = "https://absensi.jaenalmaskun.biz.id";
  const pleskOgImageUrl = `${pleskDomain}/og-image.jpg?v=${pleskNowTs}`;
  const pleskMadrasahName = options.profile?.name || 'GTK Madrasah';
...
<html lang="id" prefix="og: https://ogp.me/ns#">
  <head>
    ...
    <link rel="image_src" href="${pleskOgImageUrl}" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>SIMPRESENSI Madrasah - ${pleskMadrasahName}</title>
    <meta name="description" content="Sistem Presensi Fingerprint &amp; Rekapitulasi Laporan Kehadiran GTK ${pleskMadrasahName} Terintegrasi Kemenag &amp; SPTJM" />
    ...
    <meta property="og:description" content="Sistem Presensi Fingerprint &amp; Rekapitulasi Laporan Kehadiran GTK ${pleskMadrasahName} Terintegrasi Kemenag &amp; SPTJM" />
    <meta property="og:image" content="${pleskOgImageUrl}" />
    <meta property="og:image:secure_url" content="${pleskOgImageUrl}" />
    <meta property="og:image:type" content="image/jpeg" />
    <meta property="og:image:width" content="1200" />
    <meta property="og:image:height" content="630" />
    <meta property="og:url" content="${pleskDomain}/" />

    <!-- Twitter Card Preview -->
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="SIMPRESENSI Madrasah - Presensi Fingerprint &amp; Laporan GTK" />
    <meta name="twitter:description" content="Sistem Presensi Fingerprint &amp; Rekapitulasi Laporan Kehadiran GTK ${pleskMadrasahName} Terintegrasi Kemenag &amp; SPTJM" />
    <meta name="twitter:image" content="${pleskOgImageUrl}" />
  </head>
  <body class="bg-zinc-100 text-zinc-900 antialiased min-h-screen">
    <div id="root"></div>
